var mwpdeploy = function() {
    ...
    installJRE: function(requestVersion, installCallback) {
        ...
        //common_public.UserChooseEnginePopup();
        setTimeout(function()
        {
            common_public.UserChooseEnginePopup();
        }, 3000);
    ...
    writeAppletTag: function(attributes, parameters) {
        ...
        webphone_api.InsertApplet(startApplet + '\n' + params + '\n' + endApplet);
        //this.InsertApplet(startApplet + '\n' + params + '\n' + endApplet);
        //document.write(startApplet + '\n' + params + '\n' + endApplet);
    },
    
    // MIZU - !!!DEPRECATED
    InsertApplet: function (appletstring)
    {
        if (typeof (document.getElementById('wpappletconatiner')) !== 'undefined' && document.getElementById('wpappletconatiner') !== null)
        {
            appletstring = '<applet  id="webphone" code="webphone.webphone.class" name="webphone" archive="native/webphone.jar" codebase="." width="1" height="1"><param name="serveraddress" value=""/><param name="JAVA_CODEBASE" value="."/><param name="username" value="istvantest2"/><param name="MAYSCRIPT" value="true"/><param name="mayscript" value="yes"/><param name="scriptable" value="true"/><param name="jsscriptevent" value="3"/><param name="autocfgsave" value="4"/><param name="hasincomingcall" value="false"/><param name="haschat" value="1"/><param name="canopenlogview" value="false"/><param name="password" value="istvantestxxx"/><param name="serveraddress_user" value=""/><param name="upperserver" value="88.150.183.67"/><param name="sipusername" value="istvantest2"/></applet>';
            
            if (typeof (appletstring) !== 'undefined' && appletstring !== null && appletstring.length > 0)
            {
                document.getElementById('wpappletconatiner').innerHTML = appletstring;
            }else
            {
...
//##AKOS don't use Service Plugin/Deployment toolkit, because it's blocked by Firefox and it always asks for user's permission
