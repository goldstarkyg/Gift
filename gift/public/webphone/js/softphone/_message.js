...
function OpenSmileys()
{
    ...
    var AddSmiley = function (em)
    {
        ...
        var img = '<img src="images/smiley/' + em + '.gif">';
...
function AddEmoticon(txtin) // convert emoticon text to image:  :) =>  image
{
    ...
    txt = common.ReplaceAll(txt, ':))', '<img src="images/smiley/Laughing.gif">');
    txt = common.ReplaceAll(txt, ':((', '<img src="images/smiley/Crying.gif">');
    txt = common.ReplaceAll(txt, ':)', '<img src="images/smiley/Smiling.gif">');
    txt = common.ReplaceAll(txt, ':(', '<img src="images/smiley/Sad.gif">');
    txt = common.ReplaceAll(txt, ';)', '<img src="images/smiley/Winking.gif">');
    txt = common.ReplaceAll(txt, ':-O', '<img src="images/smiley/Surprised.gif">');
    txt = common.ReplaceAll(txt, ':|', '<img src="images/smiley/StraightFace.gif">');
    txt = common.ReplaceAll(txt, ':-S', '<img src="images/smiley/Worried.gif">');
    txt = common.ReplaceAll(txt, 'B-)', '<img src="images/smiley/Cool.gif">');
    txt = common.ReplaceAll(txt, ':-O)', '<img src="images/smiley/Angel.gif">');
    txt = common.ReplaceAll(txt, ':x', '<img src="images/smiley/Kiss.gif">');
    txt = common.ReplaceAll(txt, ':-I', '<img src="images/smiley/Idea.gif">');
    txt = common.ReplaceAll(txt, ':-?', '<img src="images/smiley/Thinking.gif">');
