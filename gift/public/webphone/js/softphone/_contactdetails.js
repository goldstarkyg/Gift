...
// needed for proper display of page height
    ...
    if (ctid >= 0)
    {
        ...
        if (isfavorite === true)
        {
            $("#btn_contactdetails_favorite").attr('src', 'images/btn_star_on_normal_holo_light.png').attr("title", stringres.get("menu_ct_unsetfavorite"));
        }else
        {
            $("#btn_contactdetails_favorite").attr('src', 'images/btn_star_off_normal_holo_light.png').attr("title", stringres.get("menu_ct_setfavorite"));
        }
    }else
    {
        iscontact = false;
...
function PopulateData()
{
    ...
    var content = '<div id="contact_name">' +
                        ...
                        '<div id="contact_blocked">' +
                            '<img src="images/icon_block.png" id="contact_blocked_img" />' +
                        '</div>' +
                        '<div id="contact_favorite">' +
                            '<img id="btn_contactdetails_favorite" style="display: none;" src="images/btn_star_off_normal_holo_light.png" title="" />' +
                        '</div>' +
                    '</div>';
            ...
            var itemcall = 
                '<div id="ct_entry_' + i + '" class="cd_container">' +
                    '<div id="cd_call_' + i + '" class="cd_call">' +
                        ...
                        '</div>' +
                        '<div class="cd_icon">' +
                            presenceimg + '<img src="images/icon_call.png" />' +
                        '</div>' +
                    '</div>' +
                '</div>';
            ...
            var itemmsg = 
                '<div id="ct_entry_' + i + '" class="cd_container">' +
                    '<div id="cd_msg_' + i + '" class="cd_call">' +
                        ...
                        '</div>' +
                        '<div class="cd_icon">' +
                            presenceimg + '<img src="images/icon_message.png" />' +
                        '</div>' +
                    '</div>' +
                '</div>';
            ...
            if (common.GetParameter2('video') === '1' || (common.GetParameter2('video') === '-1' && common.getuseengine() === global.ENGINE_WEBRTC))
            {
                ...
                '<div id="ct_entry_' + i + '" class="cd_container">' +
                    '<div id="cd_video_' + i + '" class="cd_call">' +
                        ...
                        '</div>' +
                        '<div class="cd_icon">' +
                            presenceimg + '<img src="images/btn_video_txt.png" />' +
                        '</div>' +
                    '</div>' +
                '</div>';
            }
