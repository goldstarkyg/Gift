app.controller('WorkorderController', function ($scope, $rootScope, $http, $timeout, $uibModal, $window, hotkeys, $interval, $aside, toaster, GuestService, AuthService, DateService, uiGridConstants) {
    ...
    $scope.Delete = function () {
        if($scope.workorder.id > 0) {
            var modalInstance = $uibModal.open({
                templateUrl: 'workorder_delete.html',
...
app.controller('WorkorderDeleteCtrl', function($scope, $uibModalInstance, $http, AuthService, toaster) {
    var MESSAGE_TITLE = 'Work Order';
