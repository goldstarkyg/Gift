app.controller('EquipmentEditController', function ($scope, $rootScope, $http, $interval, $stateParams, $httpParamSerializer, AuthService, GuestService, toaster) {
    ...
    $scope.uploadme = {};
    $scope.location = {};
    if($scope.equipment.location !=null) {
