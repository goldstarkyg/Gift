app.controller('CallaccountReportController', function($scope, $rootScope, $http, $httpParamSerializer, $window, $timeout, $uibModal, AuthService, toaster, liveserver) {
    ...
    $scope.iframe_style =  iframe_style1;
    $scope.onGetFrameHeight = function() {
        if(!$scope.isHidden)  $scope.iframe_style =  iframe_style1;
        else  $scope.iframe_style =  iframe_style2;
    }
    ...
    function initTimeRanger() {
        var start_time = moment().format('YYYY-MM-DD 00:00');
    ...
    function getTimeRange() {
        $scope.start_time = $scope.time_range.substring(0, '2016-01-01 00:00'.length);
        $scope.end_time = $scope.time_range.substring('2016-01-01 00:00 - '.length, '2016-01-01 00:00 - 2016-01-01 00:00'.length);
    }
