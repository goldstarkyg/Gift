app.controller('WakeupCallReportController', function($scope, $rootScope, $http, $httpParamSerializer, $window, $timeout, $uibModal, AuthService, toaster, liveserver) {
    ...
    function generateFilter() {
        ...
        $scope.filter.report_by = "wakeupcall";
        var agentlist = [];
