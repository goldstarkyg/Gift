app.controller('ComplaintDutyCreateController', function ($scope, $rootScope, $http, $interval, $timeout, $httpParamSerializer, AuthService, GuestService, toaster, Upload) {
    ...
    //$scope.guest_types = ['Walk-in', 'Arrival', 'In-House CO', 'In-House CI', 'House Complaint'];
